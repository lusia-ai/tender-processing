...
from pdf_agent.parsing.loader import PDFLoadError, fetch_pdf
from pdf_agent.parsing.parser import PDFParseError, ParsedPDF, parse_pdf

DEFAULT_SAVE_DIR = Path(__file__).resolve().parents[2] / "data" / "tenders" / "raw"
